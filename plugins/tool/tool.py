...
class Tool(Plugin):
    ...
    def _build_tool_kwargs(self, kwargs: dict):
        ...
        return {
            ...
            "arxiv_sort_by": kwargs.get("arxiv_sort_by", "relevance"),
            ...
            "bing_search_url": kwargs.get("bing_search_url", "https://api.bing.microsoft.com/v7.0/search"),
            ...
            # for email tool
            "email_nickname_mapping": kwargs.get("email_nickname_mapping", "{}"),
            ...
            "finance_news_repeat_news": kwargs.get("finance_news_repeat_news", False),
            ...
            "stt_recognition_language": kwargs.get("stt_recognition_language", "zh-CN"),
            ...
            "wechat_cpt_path": kwargs.get("wechat_cpt_path", os.path.join(get_appdata_dir(), "itchat.pkl")),
            # wechat 配置文件（`itchat.pkl`）
